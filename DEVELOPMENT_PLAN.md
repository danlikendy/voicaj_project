...
## Текущий статус: Этап 1 завершен ✅ + Базовая структура приложения готова
...
### Следующие шаги:
1. **Экран "Запись"** - добавить функциональность голосовой записи и AI анализа
2. **Управление задачами** - добавить создание, редактирование, удаление задач
3. **Экран "Календарь"** - создать визуализацию задач по датам
4. **Экран "Таймлайн"** - реализовать хронологический вид
5. **Экран "Аналитика"** - добавить графики и статистику
6. **Экран "Чат"** - интегрировать AI чат-бот
...
Face ID / Touch ID.
PIN-код (4–6 цифр).
Переключатель «Блокировать при выходе» → запрос аутентификации при каждом входе.
